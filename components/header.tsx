      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden min-[600px]:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            >
              <Link href="/" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`}>Home</Link>
              <Link href="/about" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`}>About</Link>
              <Link href="/services" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`}>Services</Link>
              <Link href="/media" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`}>Media</Link>
              <Link href="/contact" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`}>Contact</Link>
            </div>
          </nav>
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="flex flex-col space-y-6">
              <Link href="/" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`} onClick={() => setIsMenuOpen(false)}>Home</Link>
              <Link href="/about" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`} onClick={() => setIsMenuOpen(false)}>About</Link>
              <Link href="/services" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`} onClick={() => setIsMenuOpen(false)}>Services</Link>
              <Link href="/media" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`} onClick={() => setIsMenuOpen(false)}>Media</Link>
              <Link href="/contact" className={`font-normal text-[13px] transition-colors duration-300 ${isHomePage ? 'text-gray-800 hover:text-[#febf00]' : 'text-white hover:text-[#febf00]'}`} onClick={() => setIsMenuOpen(false)}>Contact</Link>
